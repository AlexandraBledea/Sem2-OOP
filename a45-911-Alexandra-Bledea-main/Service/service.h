...
int AddService(string size, string color, int price, int quantity, string photograph);

/// With this function we get the repository
/// \return returns the repository
DynamicArray<Coat>* GetRepository();

/// With this function we get the user repository
/// \return returns the user repository
DynamicArray<Coat>* GetUserRepository();
...
int DeleteService(string size, string color, string photograph, int criteria);
...
int UpdatePriceService(string size, string color, string photograph, int price);
...
/// \return returns 0 if the product was updated and 1 otherwise
int UpdateQuantityService(string size, string color, string photograph, int quantity);
